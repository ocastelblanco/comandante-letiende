...
| En preview, una escritura de un campo nuevo revierte, o una consulta nueva falla por falta de índice. | El preview no despliega reglas y **ningún job del CI despliega `firestore.indexes.json`**. | Reglas en un PR previo compatible hacia atrás; consultas resolubles con índices de campo único. |
